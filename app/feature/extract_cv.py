...
# ================= CONFIG =================
INPUT_FOLDER = r"C:\Users\pc\Documents\code\DATN\BE_InterviewAI\ai\cv_test"
OUTPUT_FOLDER = r"C:\Users\pc\Documents\code\DATN\BE_InterviewAI\ai\cv_output"
...
def robust_parse(text, max_retry=3):
    for i in range(max_retry):
        ...
        prompt = build_prompt(text)  # Không gọi mask_pii nữa
        raw = call_llm(prompt)
